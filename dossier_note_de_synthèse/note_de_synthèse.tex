...
\end{tabular}
\end{center}
Le capacity credit permet de mesurer la fiabilité d'une centrale électrique. Il correspond à la fraction de la capcité installée d'une centrale électrique sur on peut compter avec certitude à un instant donné (typiquement lors d'un pic de demande).\\
