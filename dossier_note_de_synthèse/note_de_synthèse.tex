...
\begin{figure}[!htp]
    % Figure 1 (Gauche)
    \begin{minipage}{0.48\textwidth} % Prend 48% de la largeur du texte
        \centering
        \includegraphics[width=\linewidth]{CF_2023.png} % L'image prend 100% de la minipage
        \caption{Capacity Factors 2023}
        \label{CF_2023_gauche}
    \end{minipage}%
    \hfill% (Espace horizontal pour séparer les deux minipages)
    % Figure 2 (Droite)
    \begin{minipage}{0.48\textwidth} % Prend 48% de la largeur du texte
        \centering
        \includegraphics[width=\linewidth]{CF_val_2022_WE.png} % L'image prend 100% de la minipage
        \caption{Capacity Factors 2022}
        \label{Autre_Figure}
    \end{minipage}
    
    \caption{Comparaison des Capacity Factors et d'une autre figure.} % Caption générale pour les deux figures
    \label{Figures_Cote_a_Cote}
\end{figure}
